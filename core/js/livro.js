...
$(document).ready(function(event) {
	...
	header.empty();
	header.html(
		// '<div class="top '+ COLOR_CABEC +'">'+ COURSE_NAME +' <span class="tamanho-phone-0 zerar">::</span> '+ MODULE_NUMBER +' <span class="tamanho-phone-0 zerar">::</span> '+ MODULE_NAME +'</div>'+
		'<div class="top '+ COLOR_CABEC +'">'+ MODULE_NAME +'</div>'+
		'<div class="breadcrumbs '+ COLOR_TITULO +'">'+
			// '<h1 class="'+ COLOR_MENU +'">Unidade '+ UNIDADE_NUMBER +'</h1>'+
			'<h2>'+ UNIDADE_NAME +'</h2>'+
		'</div>'+
		'<ul class="navbar '+ COLOR_MENU +'">'+
			'<li class="btnMenu"><a href="#"><img src="../core/css/img/icon-menu.png"><p class="font-green-esme">Menu</p></a></li>'+
			'<li id="navigator">'+
				'<a href="#" class="voltar '+COLOR_MENU_ARROW+' '+ (CURRENT_PAGE==1?'disabled':'') +'"><span class="icone_pai2"><img class="icone1-seta-esq" src="../core/css/img/canvas_doido.png"></span></a>'+
				'<a href="#" class="atual '+ COLOR_CABEC +'" title="Páginas">'+ CURRENT_PAGE +'</a>'+
				'<a href="#" class="total">'+ PAGES_TOTAL +'</a>'+
				'<a href="#" class="avancar '+COLOR_MENU_ARROW+' '+ (CURRENT_PAGE==PAGES_TOTAL?'disabled':'') +'"><span class="icone_pai2"><img class="icone1-seta-dir" src="../core/css/img/canvas_doido.png"></span></a>'+
			'</li>'+
		'</ul>'+
		...
		//Menu
		'<ul class="navbarMenu '+ COLOR_MENU +'">'+
			// '<li id="unidades"><a href="../unidades.html"><span class="icone_pai2"><img class="icone1-menu" src="../core/css/img/canvas_doido.png"></span>Unidades</a></li>'+
			'<li id="tamanho_fonte"><a href="#"><span class="icone_pai2"><img class="icone1-fonte" src="../core/css/img/canvas_doido.png"></span>Fonte</a></li>'+
			// '<li id="imprimir"><a href="'+ LINK_PDF +'"><span class="icone_pai2"><img class="icone1-livropdf" src="../core/css/img/canvas_doido.png"></span>Livro PDF</a></li>'+
			'<li id="tamanho_fonte"><a href="../creditos.html"><span class="icone_pai2"><img class="icone1-minicurriculo" src="../core/css/img/canvas_doido.png"></span>Créditos</a></li>'+
			// '<li id="sala"><a href="'+ LINK_SALA +'"><span class="icone_pai2"><img class="icone1-home" src="../core/css/img/canvas_doido.png"></span></a></li>'+
		'</ul>'
	);
	...
	$(".btnMenu").click(function(event){
		...
		startMenu($(".navbarMenu"));
	});
	$("#tamanho_fonte").click(function(event){
		event.preventDefault();
		startMenu($("#tamanho_fonte_menu"));
	});
	...
	//MenuHover
	$('.navbarMenu li').hover(function(){
		if($(this).hasClass( COLOR_MENU )) {
	...
	$('#tamanho_fonte_menu li').hover(function(){
		if($(this).hasClass( COLOR_MENU )) {
			$(this).removeClass( COLOR_MENU );
		}else {
			$(this).addClass( COLOR_MENU );
	...
	// $('<div class="licenseUnasus">'+

	// 		'<div class="lic">'+
	// 			'<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Licença Creative Commons" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png" /></a>'+
	// 		'</div>'+

	// 		'<div class="lic2">'+
	// 			'O trabalho <span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Livro On-line da UNA-SUS/UFMA</span> está licenciado com uma Licença'+
	...
	if(existeModal) {  
		$('<div class="refCx"><a class="referencia" href="#" target="_blank"><span class="icone_pai"><img class="icone1-referencia" src="../core/css/img/canvas_doido.png"></span></a></div>').appendTo('.conteudo')
...
function pegaIndice($objeto){
    ...
    function montaSlider($slider_container){
      ...
      linhas.each(function(){
      	var linha_temporaria = $(this);
		linha_temporaria.children().css({height: "auto"});
      	$('img').load(function(){
        	if(linha_temporaria.children().outerHeight() > alturaConteudo){
          		alturaConteudo = linha_temporaria.children().outerHeight();
        	}
        });
        if(linha_temporaria.children().outerHeight() > alturaConteudo){
          		alturaConteudo = linha_temporaria.children().outerHeight();
      ...
      // linhas.children().height(alturaConteudo+15);
      linhas.width(tamanhoLinhas);
      conteudo.width(tamanhoConteudo);
      linhas.css({verticalAlign:"bottom"});
    ...
    $(function(){
			...
			$('.cor li').each(function(){
			    tl.from($(this), 0.5, { alpha:0, x:100, ease:Elastic.easeOut });
			});
		});
